...
class DiagnosticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnostic" do
    assert_difference('Diagnostic.count') do
      post diagnostics_url, params: { diagnostic: { date_created: @diagnostic.date_created } }
    end
  ...
  test "should update diagnostic" do
    patch diagnostic_url(@diagnostic), params: { diagnostic: { date_created: @diagnostic.date_created } }
