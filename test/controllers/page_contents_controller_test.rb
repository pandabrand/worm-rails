...
class PageContentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create page_content" do
    assert_difference('PageContent.count') do
      post page_contents_url, params: { page_content: { is_personalized: @page_content.is_personalized, name: @page_content.name, wo_html: @page_content.wo_html, wo_wod: @page_content.wo_wod } }
    end
  ...
  test "should update page_content" do
    patch page_content_url(@page_content), params: { page_content: { is_personalized: @page_content.is_personalized, name: @page_content.name, wo_html: @page_content.wo_html, wo_wod: @page_content.wo_wod } }
