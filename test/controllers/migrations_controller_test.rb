...
class MigrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create migration" do
    assert_difference('Migration.count') do
      post migrations_url, params: { migration: { batch: @migration.batch, migration_time: @migration.migration_time, name: @migration.name } }
    end
  ...
  test "should update migration" do
    patch migration_url(@migration), params: { migration: { batch: @migration.batch, migration_time: @migration.migration_time, name: @migration.name } }
