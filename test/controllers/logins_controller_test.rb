...
class LoginsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post logins_url, params: { login: { action: @login.action, fk_user_id: @login.fk_user_id, login_date: @login.login_date } }
    end
  ...
  test "should update login" do
    patch login_url(@login), params: { login: { action: @login.action, fk_user_id: @login.fk_user_id, login_date: @login.login_date } }
